...
export const RegisterPatientView = (props: propsView) => {

    const { token: { colorPrimary } } = theme.useToken()

    return (
        <div className={"m-3 bg-white border-2  rounded-t-md rounded-b-md "} style={{ borderColor: colorPrimary }}>
            <div className="h-[3rem] flex items-center pl-4" style={{ backgroundColor: colorPrimary }}>
